              ...
              <CardContent className="space-y-8">
                  ...
                  <div className="space-y-4">
                    ...
                    <ul className="space-y-4">
                      {exp.impact.map((point, i) => (
                        <li key={i} className="text-[11px] md:text-sm text-muted-foreground leading-snug flex gap-3">
                ...
                {exp.testimonial && (
                  <div className="p-6 bg-primary/[0.03] border-l-4 border-primary/40 rounded-r-2xl italic">
                    <p className="text-sm md:text-sm text-foreground/90 leading-relaxed mb-4">"{exp.testimonial.text}"</p>
