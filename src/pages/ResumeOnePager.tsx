        ...
        <section className="mb-3">
          ...
          <div className="mb-2.5">
            ...
            <ul className="list-disc ml-4 text-[10px] space-y-0 text-gray-900 leading-tight">
              ...
              <li><strong>Search Transformation:</strong> Orchestrated search redesign resulting in <strong>+106% search engagement</strong> and increasing Monthly NPS to <strong>79 (+18pp MoM)</strong>. Enhanced search with vector embeddings.</li>
