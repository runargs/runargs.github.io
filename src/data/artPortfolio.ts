...
export const artProjects: ArtProject[] = [
  ...
  },
  {
    ...
    media: [
      ...
      instagram("https://www.instagram.com/reel/DbAEJ64unUR/", "/media/art/instagram-farm-supper-club.jpg", "Farm supper club dinner service", 360, 640, "reel", "/media/art/instagram-reel-DbAEJ64unUR.mp4"),
    ],
    layout: "feature",
    featured: true,
    storyOrder: 5,
