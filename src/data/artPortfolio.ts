...
export const artProjects: ArtProject[] = [
  ...
  {
    id: "vineyard-dinner-place-setting",
    title: "Vineyard dinner place setting",
    practice: "food",
    medium: "Event dining",
    media: [image("/media/art/vineyard-dinner-place-setting.jpg", "Colorful vineyard dinner place setting with menu, flowers, glassware, and a wax-dripped bottle", 3264, 4912)],
    layout: "tall",
  },
  {
    id: "filipino-suman",
  ...
  {
    id: "outdoor-dinner-tables",
    title: "Outdoor dinner tables",
    practice: "food",
    medium: "Event dining",
    media: [image("/media/art/outdoor-dinner-tables.png", "Tables and chairs arranged beneath a flower-lined canopy before an outdoor dinner", 1086, 1358)],
    layout: "tall",
  },
  {
  ...
  {
    id: "vineyard-dinner-leaf-wrapped-fish",
    title: "Leaf-wrapped fish",
    practice: "food",
    medium: "Live-fire cooking",
    media: [image("/media/art/vineyard-dinner-leaf-wrapped-fish.jpg", "Leaf-wrapped fish hanging beside grapes and onions in golden-hour light", 3264, 4912)],
    layout: "tall",
  },
  {
    id: "sesame-cookies",
  ...
  {
    id: "outdoor-dinner-night",
    title: "Dinner after dark",
    practice: "food",
    medium: "Event dining",
    media: [image("/media/art/outdoor-dinner-night.png", "Guests sharing an outdoor dinner beneath a canopy at night", 1074, 1464)],
    layout: "tall",
  },
  {
    id: "catering-prep",
  ...
  {
    id: "vineyard-dinner-charred-grapes",
    title: "Charred grapes",
    practice: "food",
    medium: "Live-fire cooking",
    media: [image("/media/art/vineyard-dinner-charred-grapes.jpg", "Charred grapes being served from a silver coupe", 3264, 4912)],
    layout: "tall",
  },
  {
  ...
  {
    id: "vineyard-dinner-toast",
    title: "A toast at the table",
    practice: "food",
    medium: "Event dining / moving image",
    media: [{
      kind: "video",
  ...
  {
    id: "vineyard-dinner-team",
    title: "Vineyard dinner team",
    practice: "food",
    medium: "Culinary collaboration",
    media: [image("/media/art/vineyard-dinner-team.jpg", "Three-person culinary team beside the live-fire setup after assisting with the vineyard dinner", 4912, 3264)],
    layout: "wide",
  },
  {
    id: "ginkgo-bowl",
